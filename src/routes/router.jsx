...
const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      { path: 'dashboard', element: withProtectedRoute(<DashboardPage />, ['admin', 'manager', 'employee', 'compliance_officer', 'auditor']) },
      ...
      { path: 'risk', element: withProtectedRoute(<RiskPage />, ['admin', 'manager', 'compliance_officer', 'auditor']) },
      { path: 'compliance', element: withProtectedRoute(<CompliancePage />, ['admin', 'manager', 'compliance_officer']) },
      { path: 'audit', element: withProtectedRoute(<AuditPage />, ['admin', 'manager', 'auditor']) },
      ...
      { path: 'reports', element: withProtectedRoute(<ReportsPage />, ['admin', 'manager']) },
      { path: 'settings', element: withProtectedRoute(<SettingsPage />, ['admin', 'manager', 'employee', 'compliance_officer', 'auditor']) },
    ],
  },
  {
    path: '*',
